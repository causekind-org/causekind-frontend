...
export default function CampaignsPage() {
  ...
  useEffect(() => {
    getCampaigns().then(setCampaigns).catch(() => setError("Could not load campaigns.")).finally(() => setLoading(false));
  }, []);
        ...
        <Reveal>
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <div className="relative flex-1">
              ...
              <Input className="pl-9 rounded-xl border-orange-100 dark:border-stone-800 focus-visible:ring-[#b04a15]/20 bg-white dark:bg-zinc-900 dark:text-stone-100" placeholder="Search by cause, city, organizer…" value={search} onChange={e => setSearch(e.target.value)} />
            </div>
