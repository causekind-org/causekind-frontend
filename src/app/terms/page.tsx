        ...
        <div className="lg:grid lg:grid-cols-[220px_1fr] lg:gap-12">
          ...
          <main className="min-w-0">
            ...
            <Reveal className="mb-8">
              <div className="rounded-2xl border border-[#b04a15]/15 bg-gradient-to-br from-[#fff7f0] to-[#fdeede] p-5 text-sm font-medium leading-relaxed text-stone-600 dark:border-orange-400/15 dark:from-zinc-900 dark:to-zinc-900/60 dark:text-stone-300">
              ...
              <Section id="items" num="09" title="Item Listings, Requests & Matches" icon={Package}>
                <Bullets
                  items={[
                    ...
                    "Recipients submitting an Item Request may be asked to complete identity verification appropriate to the tier of their request, which can include a residence-proof document (such as a utility bill, rental agreement, ration card, voter ID, or bank statement) and a supporting photo. This information is collected solely for admin-side verification of genuine need and to prevent fraud — it is stored in access-controlled cloud storage, is never displayed to donors, other recipients, or any user other than the submitter, and is only accessible to authorized CauseKind administrators for the purpose of reviewing and approving the request.",
                  ]}
                />
              </Section>
