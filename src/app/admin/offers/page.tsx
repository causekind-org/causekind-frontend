...
export default function AdminOffersPage() {
  ...
  const FILTER_OPTIONS = [
    ...
    { key: "ALL",       label: "All Offers",      statuses: [] },
  ...
  useEffect(() => { if (!isLoading && user) load(); }, [filter]);
      ...
      <div className="bg-gradient-to-r from-[#0f1d30] via-[#1c0905] to-[#1e2d10] text-white py-8 px-4">
        <div className="mx-auto max-w-5xl flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={load} className="rounded-xl bg-white/10 px-3 py-2 hover:bg-white/20">
