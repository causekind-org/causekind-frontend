...
export const CATEGORY_VISUALS: Record<string, CategoryVisual> = {
  "Medical aid": { Icon: Stethoscope, text: "text-sky-700 dark:text-sky-400",     fallbackImage: "/images/categories/medical-aid-v2.jpg",
  ...
  "Education":   { Icon: BookOpen,    text: "text-amber-700 dark:text-amber-400", fallbackImage: "/images/categories/education-v2.jpg",
  ...
  "Livelihood":  { Icon: Sprout,      text: "text-emerald-700 dark:text-emerald-400", fallbackImage: "/images/categories/livelihood-v2.jpg",
  ...
  "Relief":      { Icon: Users,       text: "text-violet-700 dark:text-violet-400",   fallbackImage: "/images/categories/relief-v2.jpg",
  ...
  "Household":   { Icon: HomeIcon,    text: "text-rose-700 dark:text-rose-400",   fallbackImage: "/images/categories/household.webp",
  ...
  "Furniture":   { Icon: Armchair,    text: "text-indigo-700 dark:text-indigo-400", fallbackImage: "/images/categories/furniture.webp",
  ...
  "Clothing":    { Icon: Shirt,       text: "text-teal-700 dark:text-teal-400",   fallbackImage: "/images/categories/clothing.webp",
  ...
  "Electronics": { Icon: Smartphone,  text: "text-orange-700 dark:text-orange-400", fallbackImage: "/images/categories/electronics.webp",
  ...
  "Sports":      { Icon: Dumbbell,    text: "text-cyan-700 dark:text-cyan-400",   fallbackImage: "/images/categories/sports.webp",
