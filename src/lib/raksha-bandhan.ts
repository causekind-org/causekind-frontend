...
//
// Used by the hero card and the homepage "Unclaimed" section. Kept in this file
// rather than a second one so there is a single campaign module, and so the
// window above cannot drift from the surfaces that read it.
 ...
 * move with where it is read. Contrast {@link istDateString} above, which is a
 * *date* and therefore must be pinned to India — the two are different
 * problems and are deliberately solved differently.
 *
