...
describe("isGanpatiActive", () => {
  ...
  it("returns true at the very end of 24th September 2026 IST", () => {
    expect(isGanpatiActive(GANPATI_END)).toBe(true);
  });

  it("returns false after 24th September 2026 23:59:59 IST", () => {
    // 25 Sept 2026 00:00:01 IST
    const afterDate = new Date("2026-09-24T18:30:01.000Z");
