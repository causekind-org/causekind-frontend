...
export function CauseKindLogo({ size = "md" }: { size?: "sm" | "md" | "lg" }) {
  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" fill="none" className="h-8 w-8 text-[#b04a15] dark:text-orange-400 shrink-0" xmlns="http://www.w3.org/2000/svg">
      ...
      <span className="flex items-center text-stone-900 dark:text-stone-100 font-extrabold text-xl">
