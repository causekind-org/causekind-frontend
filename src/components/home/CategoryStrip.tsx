...
export function CategoryStrip() {
  ...
  return (
    <nav
      ...
      className="w-full rounded-[1.5rem] bg-white/96 px-3 py-3.5 shadow-[0_0_0_1px_rgba(0,0,0,0.06),0_14px_38px_rgba(79,47,25,0.13)] backdrop-blur-sm dark:bg-stone-950/94 dark:shadow-[0_0_0_1px_rgba(255,255,255,0.1),0_14px_38px_rgba(0,0,0,0.28)] sm:px-4 lg:px-5 lg:py-4"
    >
