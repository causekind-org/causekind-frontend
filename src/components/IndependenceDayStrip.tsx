...
export function IndependenceDayStrip() {
  ...
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-y-0 left-0 w-[38rem] max-w-[75%] overflow-hidden bg-[linear-gradient(to_bottom,#ff9933_0%,#ff9933_33.333%,#ffffff_33.333%,#ffffff_66.666%,#138808_66.666%,#138808_100%)]"
      >
        <div className="absolute inset-0 bg-gradient-to-r from-black/20 via-transparent to-[#075942]" />
        <div className="absolute left-[15%] top-1/2 h-7 w-7 -translate-y-1/2 rounded-full border-2 border-[#123f75]/85 shadow-[0_0_0_2px_rgba(255,255,255,0.32)] sm:h-9 sm:w-9">
          <div className="absolute inset-[4px] rounded-full border border-dashed border-[#123f75]/75 sm:inset-[5px]" />
          <div className="absolute left-1/2 top-1/2 h-1.5 w-1.5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#123f75]/85" />
        </div>
      </div>
      <div
        aria-hidden="true"
      ...
      <div className="relative flex min-h-12 w-full items-center gap-3 px-4 py-1.5 sm:min-h-14 sm:gap-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden shrink-0 items-center gap-2 min-[720px]:flex">
          <Link
            href="/items/new"
            className="inline-flex min-h-10 items-center justify-center gap-1.5 rounded-lg border border-white/45 bg-[#075942]/80 px-3.5 py-2 text-xs font-extrabold text-white shadow-sm backdrop-blur-[1px] transition-[transform,background-color,border-color] duration-200 hover:border-white/70 hover:bg-white/15 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#075942] active:scale-[0.98] motion-reduce:transition-none motion-reduce:active:scale-100"
          >
            List an item
          ...
          <Link
            ...
            className="inline-flex min-h-10 items-center justify-center gap-1.5 rounded-lg bg-white px-3.5 py-2 text-xs font-extrabold text-[#075942] shadow-sm transition-[transform,background-color,color] duration-200 hover:bg-[#fff5e8] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#075942] active:scale-[0.98] motion-reduce:transition-none motion-reduce:active:scale-100"
          >
            Browse Needs
