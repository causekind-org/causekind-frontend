      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          <div className="lg:w-2/5">
            <span className="inline-block px-4 py-1.5 rounded-full bg-brand-50 dark:bg-brand-500/10 border border-brand-100 dark:border-brand-500/25 text-brand-700 dark:text-brand-300 text-xs font-semibold tracking-wider uppercase mb-6">
          ...
          <div className="lg:w-3/5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {areas.map((area, index) => (
                <div
                  key={index}
                  className="flex flex-col sm:flex-row gap-5 p-6 rounded-2xl border border-stone-100 dark:border-white/10 bg-white dark:bg-zinc-900 hover:shadow-sm transition-all duration-300"
                >
